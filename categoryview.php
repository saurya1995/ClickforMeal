...
$query_products = "SELECT * FROM '$name' ";
        ...
        <div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
					        <li ><a href="index.php" class="hyper "><span>Insert Product</span></a></li>	
							<li ><a href="allview.php?name=products" class="hyper "><span>View Products</span></a></li>	
							<li ><a href="allview.php?name=categories" class="hyper "><span>View Categories</span></a></li>	
							<li ><a href="allview.php?name=customers" class="hyper "><span>View Customers</span></a></li>	
							<li ><a href="index.php" class="hyper "><span>View Orders</span></a></li>	
							<li ><a href="index.php" class="hyper "><span>View Payments</span></a></li>	
 ...
 <style>
		table {
           ...
           <table width="1659" height="50" border="1">  
                <tr>  
                     <th align="center" width="04%">Customer_Id</th>  
                     <th align="center" width="20%">Name</th> 
					 <th align="center" width="31%">Email</th>   
					 <th align="center" width="05%">Password</th> 
 ...
 {  
      ...
      {  
              ...
              ?>  <tr> 
                     ...
                     <td align="center"><?php echo $row_Recordset1["customer_id"]?></td>  
                     <td align="center"><?php echo $row_Recordset1["customer_name"]?></td>  
					 <td align="center"><?php echo $row_Recordset1["customer_email"]?></td>
					 <td align="center"><?php echo $row_Recordset1["customer_pass"]?></td> 
					 <td align="center"><?php echo $row_Recordset1["customer_contact"]?></td> 
