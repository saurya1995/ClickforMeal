...
<br><br></br></br>
		...
		table {
           ...
           <table width="1659" height="50" border="1">  
                <tr>  
                     <th align="center" width="41%">Email</th>  
                     <th align="center" width="04%">Product_Id</th> 
					 <th align="center" width="25%">Name</th>   
					 <th align="center" width="05%">Quantity</th> 
      ...
      {  
              ...
              ?>  <tr> 
                    ...
                    <td align="center"><?php echo $row_Recordset1["email"]?></td>  
                     <td align="center"><?php echo $row_Recordset1["product_id"]?></td>  
					 <td align="center"><?php echo $row_Recordset1["name"]?></td>
					 <td align="center"><?php echo $row_Recordset1["quantity"]?></td> 
