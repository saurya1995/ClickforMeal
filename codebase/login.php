...
if (isset($_POST['customer_email'])) {
  $loginUsername=mysql_real_escape_string($_POST['customer_email']);
  ...
  $LoginRS__query=sprintf("SELECT customer_email, customer_pass FROM customers WHERE customer_email=%s AND customer_pass=%s",
    GetSQLValueString($loginUsername, "text"), GetSQLValueString($encrypt_pass, "text")); 
	...
	<div class="login">
		...
		<div class="main-agileits">
				<div class="form-w3agile">
					<h3>Login</h3>
					<form name="loginform" action="<?php echo $loginFormAction; ?>" method="POST">
						<div class="key">
