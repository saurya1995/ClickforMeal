...
exit();}?>
<?php $email=$_SESSION['MM_Username']; 
		...
		<div class=" contact-w3">	
			...
			<div class="col-md-7 contact-left">
				...
				<ul class="contact-list">
					<li> <i class="fa fa-map-marker" aria-hidden="true"></i> 756 Global Place, Dehradun.</li>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:example@mail.com">teamasva@gmail.com</a></li>
					<li> <i class="fa fa-phone" aria-hidden="true"></i>+91 9411178219</li>
				</ul>
				<div id="container">
					<!--Horizontal Tab-->
						...
						<div class="resp-tabs-container hor_1">
							...
							<div>
								<div class="map-grid">
									...
									<ul>
										<li>Mobile No : +91 9411178219</li>
										<li>Office No : +91 8439793210</li>
