...
$query_products = "SELECT * FROM products where cat_id='p'";
$query_product = "SELECT * FROM products where cat_id='p2'";
$query_produc = "SELECT * FROM products where cat_id='p3'";
  ...
  <!---->
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
           <a href="#"><img class="second-slide " src="images/slider/3.jpg" alt="Third slide"></a>
...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/cakes/v1.jpg" class="img-responsive" alt="">
			</a>
		...
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/cakes/v2.jpg" class="img-responsive" alt="">
			</a>
			<h6>Rice Pudding</h6>
			<p></p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/cakes/v3.jpg" class="img-responsive" alt="">
			</a>
			<h6>Mousse Cake</h6>
			<p></p>
		</div>
		...
		<div class="container">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  <li class="active"><a href="#tab1" data-toggle="tab">Puddings</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">Ice-Cream</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Deserts</a></li>  
					</ul>
<!--content-->
