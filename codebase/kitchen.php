...
$query_products = "SELECT * FROM products where cat_id='b1'";
$query_product = "SELECT * FROM products where cat_id='b2'";
$query_produc = "SELECT * FROM products where cat_id='b3'";
									...
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												...
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i><b>Burger</b></a></li>
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Herb Burger</a></li>
												<li><a href="kitchen.php"> <i class="fa fa-angle-right" aria-hidden="true"></i>Lamb Burger</a></li>
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Schnitzel Burger</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i><b>Pizzas</b></a></li>
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Margherita</a></li>
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Vegetariana</a></li>
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Papperoni</a></li>
										...
										<div class="col-sm-3">
											...
											<ul class="multi-column-dropdown">
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i><b>Chinese</b></a></li>
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Hakka Noodles</a></li>
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Schezwan Noodles</a></li>
												<li><a href="kitchen.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Gravy Roll</a></li>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
           <a href="#"><img class="first-slide" src="images/slider/1.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="#"> <img class="second-slide " src="images/slider/2.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
           <a href="#"><img class="third-slide " src="images/slider/3.jpg" alt="Third slide"></a>
          
        </div>
		        <div class="item">
           <a href="#"><img class="third-slide " src="images/slider/4.jpg" alt="Third slide"></a>
...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/bc1.jpg" class="img-responsive" alt="">
			</a>
			<h6>Forest Fire</h6>
			<p></p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/bc3.jpg" class="img-responsive" alt="">
			</a>
			<h6>Cappaccino</h6>
			<p></p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/bc2.jpg" class="img-responsive" alt="">
			</a>
			<h6>Coconut Water</h6>
			<p></p>
		</div>
		...
		<div class="container">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  <li class="active"><a href="#tab1" data-toggle="tab">Mocktails</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">Tea And Coffee</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Other Beverages</a></li>  
					</ul>
<!--content-->
					    ...
					    <div class="col-m">
									...
									<?php echo $row_products["product_title"];?>
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="<?php echo $row_products["product_id"];?>" data-name="<?php echo $row_products["product_title"];?>" data-summary="summary 3"  data-price="<?php echo $row_products["product_price"];?>" data-quantity="1" data-image="<?php echo $row_products["product_image"];?>">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
					      ...
					      <div class="modal fade" id="<?php echo $row_products["image_id"];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"></p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="<?php echo $row_products["product_id"];?>" data-name="<?php echo $row_products["product_title"];?>" data-summary="summary 26" data-price="<?php echo $row_products["product_price"];?>" data-quantity="1" data-image="<?php echo $row_products["product_image"];?>">Add to Cart</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
								...
								<div class="col-m">
									...
									<?php echo $row_produc["product_title"];?>
										...
										<div class="mid-2">
											...
											<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="<?php echo $row_produc["product_id"];?>" data-name="<?php echo $row_produc["product_title"];?>" data-summary="summary 3"  data-price="<?php echo $row_produc["product_price"];?>" data-quantity="1" data-image="<?php echo $row_produc["product_image"];?>">Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
                            
                 <div class="modal fade" id="<?php echo $row_produc["image_id"];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>						
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para"> </p>
									<div class="price_single">
									  <span class="reducedfrom "><?php echo $row_produc["product_price"];?></span>
									...
									<p class="quick_desc"></p>
									 <div class="add-to">
                                  <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="<?php echo $row_produc["product_id"];?>" data-name="<?php echo $row_produc["product_title"];?>" data-summary="summary 26" data-price="<?php echo $row_produc["product_price"];?>" data-quantity="1" data-image="<?php echo $row_produc["product_image"];?>">Add to Cart</button>
					...
					<div class="tab-pane  text-style" id="tab3">
						...
						<div class="col-md-3 pro-1">
								<div class="col-m">
									...
									<?php echo $row_product["product_title"];?>
										...
										<div class="mid-2">
											...
											<div class="add">
                                             <button class="btn btn-danger my-cart-btn my-cart-b" data-id="<?php echo $row_product["product_id"];?>" data-name="<?php echo $row_product["product_title"];?>" data-summary="summary 3"  data-price="<?php echo $row_product["product_price"];?>" data-quantity="1" data-image="<?php echo $row_product["product_image"];?>">Add to Cart</button>
											</div>
									</div>
								</div>
							</div>
					      ...
					      <div class="modal fade" id="<?php echo $row_product["image_id"];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-info">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>						
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<div class="price_single">
									  <span class="reducedfrom "><?php echo $row_product["product_price"];?></span>
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="<?php echo $row_product["product_id"];?>" data-name="<?php echo $row_product["product_title"];?>" data-summary="summary 26" data-price="<?php echo $row_product["product_price"];?>" data-quantity="1" data-image="<?php echo $row_product["product_image"];?>">Add to Cart</button>
