...
$query_products = "SELECT * FROM categories; ";
$products = mysql_query($query_products, $MyConnection) or die(mysql_error());}
else {
        ...
        <div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li ><a href="order.php?name=order" class="hyper "><span>View Orders</span></a></li>
...
<br><br></br></br>
		...
		<?php if($name=="categories"){ ?>
           <table width="1659" height="50" border="1">  
                <tr>  
                     <th align="center" width="50%">Castegory_Id</th>  
                     <th align="center" width="50%">Category_Name</th> 
 ...
 {  
      ...
      {  
              ...
              ?>  <tr> 
                     ...
                     <td align="center"><?php echo $row_Recordset1["cat_id"]?></td>  
                     <td align="center"><?php echo $row_Recordset1["cat_title"]?></td>  
