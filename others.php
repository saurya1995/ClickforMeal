...
$query_products = "SELECT * FROM products where cat_id='o1'";
$query_product = "SELECT * FROM products where cat_id='o2'";
$query_produc = "SELECT * FROM products where cat_id='o3'";
...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/others/1.jpg" class="img-responsive" alt="">
			</a>
			<h6>Burger</h6>
			<p></p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/others/2.jpg" class="img-responsive" alt="">
			</a>
			<h6>Pizza</h6>
			<p></p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="#">
				<img src="images/others/3.jpg" class="img-responsive" alt="">
			</a>
			<h6>Noodles</h6>
			<p></p>
		</div>
		...
		<div class="container">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  <li class="active"><a href="#tab1" data-toggle="tab">Burger</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">Chinese</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Pizzas</a></li>  
					</ul>
<!--content-->
